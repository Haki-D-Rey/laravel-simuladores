...
class TipoUsuarioImporter extends Importer
{
    ...
    public function resolveRecord(): ?TipoUsuario
    {
        $value = TipoUsuario::where('codigointerno', $this->data['codigointerno'])->first();
        ...
        if ($value) {
            ...
            // Create a new record
            return TipoUsuario::updateOrCreate(
                [
