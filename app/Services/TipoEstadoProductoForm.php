...
final class TipoEstadoProductoForm
{
            ...
            Grid::make([
                ...
                ->schema([
                    TextInput::make('descripcion')
                        ->required()
                        ->unique(TipoEstadoProducto::class, 'descripcion', ignoreRecord: true)
                        ->maxLength(128)
                        ->label('Descripcion')
                        ->validationMessages([
                    ...
                    TextInput::make('codigointerno')
                        ->required()
                        ->unique(TipoEstadoProducto::class, 'codigointerno', ignoreRecord: true)
                        ->maxLength(64)
                        ->label('Codigo')
                        ->validationMessages([
