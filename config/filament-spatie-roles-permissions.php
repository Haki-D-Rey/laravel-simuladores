...
return [
    ...
    'navigation_section_group' => 'Administracion y Gestion', //'filament-spatie-roles-permissions::filament-spatie.section.roles_and_permissions', // Default uses language constant
